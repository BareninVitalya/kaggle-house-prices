...
отличие от более простой учебной регрессии, House Prices хорошо показывает, насколько важны качественная обработка пропусков, корректная работа с категориальными признаками, логарифмирование скошенных распределений и feature engineering. Именно поэтому в проекте сочетаются ручные признаки, OpenFE, ансамбли, DNN-модель и отдельный модуль тюнинга, что соответствует духу самого соревнования Kaggle, где акцент сделан на feature engineering и продвинутых регрессионных техниках. [web:193]